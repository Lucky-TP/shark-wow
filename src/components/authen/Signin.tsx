...
export default function SigninByToey({}: Props) {
                ...
                <div className="w-full pl-20">
                    ...
                    <div className="flex flex-col mt-24">
                        ...
                        <div className="w-full text-center mb-4">
                            <Button className="bg-white  items-center px-16 py-4  rounded-full shadow-md hover:bg-gray-200 transition">
                                {/* <img src="https://ssl.gstatic.com/ui/v1/icons/mail/rfr/gmail.ico" alt="Gmail logo" className="w-6 h-6 mr-2"/> */}
                                <span className="text-gray-700 mx-8">SIGN IN</span>
                            </Button>
                        </div>
                        ...
                        <div className="w-full text-center mb-4">
                            <Button className="bg-white  items-center px-2 py-4 rounded-full shadow-md hover:bg-gray-200 transition" loading={loading} onClick={() => onSignIn()}>
                                <img src="https://ssl.gstatic.com/ui/v1/icons/mail/rfr/gmail.ico" alt="Gmail logo" className="w-6 h-6 mr-2 pl-0.5"/>
                                <span className="text-gray-700 px- mx-6">SIGN IN WITH GMAIL</span>
                            </Button>
                        </div>
                        <div className="w-full text-center mb-4">
                            <Button className="bg-white  items-center  px-2 py-4 rounded-full shadow-md hover:bg-gray-200 transition" loading={loading} onClick={() => onSignIn()}>
