...
export default function SignupPlaceHolder({}: Props) {
            ...
            <div className="w-full flex flex-col justify-center items-center bg-white p-16 rounded-tl-4xl">
                <div className="w-full pl-20">
                    ...
                    <div className="flex flex-col mt-24">
                        ...
                        {/* <div className="w-full text-center mb-4">
                            <button className="bg-orange-300  items-center px-3 py-1 my-0.5 rounded-full shadow-md hover:bg-orange-200 transition">
                                <div className='flex'>
