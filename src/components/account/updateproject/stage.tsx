...
export default function Projecttitle({}: Props) { // เปลี่ยนชื่อเป็น UserProfile
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#E5D8CA]">
        <div className="bg-[#E59A73] rounded-lg border-4 border-blue-400 p-10 max-w-md">
            <h3 className="text-2xl font-semibold mb-4">Stage 1</h3>
            <p className="text-lg mb-6">Concept</p>
            
            <div className="flex items-center mb-4">
            <AiOutlineCheckCircle className="text-green-600 h-8 w-8" /> {/* ใช้ไอคอนจาก react-icons */}
