      ...
      <div className='pl-6 p-3'>
        <div className="w-full h-full  rounded-lg overflow-hidden relative group">
            <div className="relative">
                <img className="size-60  object-cover" src={`/${product.images}`} alt="project img"/>
                {/* <!-- Hover elements --> */}
                <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity duration-300">
                    <button className="absolute bottom-2 bg-orange-600 text-white font-semibold py-2 px-4 rounded-full">View Project</button>
                </div>
            ...
            <div className="pt-3 py-1">
                ...
                <p className="text-sm text-gray-600 mt-1">Fund at $3</p>
            </div>
            <div >
