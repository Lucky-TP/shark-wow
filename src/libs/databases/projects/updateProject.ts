    ...
    try {
        await runTransaction(async (transaction) => {
            ...
            const updateData: Partial<ProjectModel> = {
                ...
                carouselImageUrls:
                    newProjectData.carouselImageUrls ??
                ...
                totalSupporter:
                    newProjectData.totalSupporter ??
                    currentProjectData.totalSupporter,
                totalQuantity:
                    newProjectData.totalQuantity ??
                    currentProjectData.totalQuantity,
                costPerQuantity:
                    newProjectData.costPerQuantity ??
                    currentProjectData.costPerQuantity,
                status: newProjectData.status ?? currentProjectData.status,
                category:
                    newProjectData.category ?? currentProjectData.category,
                stages: newProjectData.stages ?? currentProjectData.stages,
                story: newProjectData.story ?? currentProjectData.story,
                discussionIds:
                    newProjectData.discussionIds ??
                    currentProjectData.discussionIds,
